addLayer("g", {
    ...
    exponent() {
        ...
        if(player.g.points.gt(11)) exp = player.g.points.sub(11).mul(0.1).min(1)
        return exp
    ...
    glGeneration() {
        let base = new Decimal(1), mult = new Decimal(1), ge = player.g.points
        ...
        mult = mult.add(buyableEffect("b",21))
        mult = mult.add(tmp.r.gEnergyEff2)
        if(hasUpgrade("g",54)) ge = ge.add(1)
        if(hasUpgrade("b",51)) ge = ge.add(0.25)
        let gain = base.pow(ge).mul(mult)
        ...
        if(hasUpgrade("g",42)) gain = gain.add(getPointGen().mul(hasMilestone("r",8)?0:hasUpgrade("g",45)?0.2:0.1))
        if(hasUpgrade("g",43)) gain = gain.add(1000)
        if(hasMilestone("r",0)) gain = gain.add(3000)
        gain = gain.mul(tmp.r.bEnergyEff3)
        ...
        if(getBuyableAmount("r",12).gte(17)) gain = gain.add(tmp.r.gEnergyEff4)
        return gain
    },
    ...
    upgrades: {
        ...
        13: {
            title: "Green #3",
            description: "+3 points gain, BE cap +10.",
        ...
        14: {
            title: "Green #4",
            description: "First dependent multiplier! gl^0.25 adds to points gain.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
            effect() {
                let eff = player.g.gl.pow(0.25)
                if(hasUpgrade("b",32)) eff = eff.mul(3)
        ...
        15: {
            title: "Green #5",
            description: "Unlock a blue buyable, BE cap +30.",
            currencyDisplayName: "Blue Essence",
            currencyInternalName: "points",
            currencyLayer: "b",
        ...
        21: {
            ...
            currencyLayer: "b",
            effect() {
                let eff = player.b.pointsCap.pow(0.3)
                return eff
            },
            effectDisplay() {return "+"+format(this.effect())},
        ...
        23: {
            ...
            effect() {
                ...
                if(hasUpgrade("g",35)) eff = player.b.pointsCap.div(3)
                return eff
            },
            effectDisplay() {return "+"+format(this.effect())},
        ...
        31: {
            title: "Green #11",
            description: "Points affects Green Light gain with reduced effect.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
            effect() {
                let eff = player.points.pow(0.2).mul(2.5)
                return eff
            },
            effectDisplay() {return "+"+format(this.effect())},
        ...
        32: {
            ...
            effect() {
                ...
                let eff = [totalBuys.mul(3),totalBuys]
                return eff
            },
        ...
        33: {
            title: "Green #13",
            description: "+100 points and Green Light gain. +250 BE cap.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
        ...
        42: {
            title: "Green #17",
            description() {
                let desc = "The gain of points and Green Light boosts each other with a 10% ratio.", effText = ""
                if(hasUpgrade("r",13)) {
            ...
            unlocked() {return getBuyableAmount("b",21).gte(2)&&!hideUpgs(this.layer,this.id)},
            style() {
                let sty = {'touch-action':'manipulation'}
                if(hasMilestone("r",8)&&!hasUpgrade("r",13)) sty = {'touch-action':'manipulation', 'background':'gray'}
                return sty
            },
        },
        43: {
            title: "Green #18",
            description: "+1,000 points and Green Light gain. +350 BE cap.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
        ...
        45: {
            title: "Green #20",
            description() {
                let desc = "Green #17 now becomes 20%."
            ...
            style() {
                let sty = {'touch-action':'manipulation'}
                if(hasMilestone("r",8)&&!hasUpgrade("r",14)) sty = {'touch-action':'manipulation', 'background':'gray'}
                return sty
            },
        },
        51: {
            title: "Green #21",
            description: "+100,000 points gain, again.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
        ...
        52: {
            ...
            unlocked() {return hasUpgrade(this.layer,51)&&!hideUpgs(this.layer,this.id)},
            style: {'touch-action':'manipulation'},
        },
        53: {
            title: "Green #23",
            description: "+0.1 Blue #B4 base.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
            cost: new Decimal(3e8),
            unlocked() {return hasUpgrade(this.layer,52)&&!hideUpgs(this.layer,this.id)},
            style: {'touch-action':'manipulation'},
        },
        54: {
            title: "Green #24",
            ...
            unlocked() {return hasUpgrade(this.layer,53)&&!hideUpgs(this.layer,this.id)},
            style: {'touch-action':'manipulation'},
        },
        55: {
            title: "Green #25",
            description() {return "+"+formatWhole(1e6)+" points gain. Blue #4 no longer costs anything."},
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
            cost: new Decimal(1e9),
            unlocked() {return hasUpgrade(this.layer,54)&&!hideUpgs(this.layer,this.id)},
            style: {'touch-action':'manipulation'},
        },
        61: {
            title: "Green #26",
        ...
        64: {
            title: "Green #29",
            description: "+0.1 Green Light base. BEG1 is 50% stronger.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
        ...
        71: {
            title: "Green #31",
            description: "x4 GEG4, x3 BEG4, BEG2 softcap is 20% weaker.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
        ...
        72: {
            title: "Green #32",
            description: "x4 GEG4, x2 BEG4, significantly soften Blue #2 cost increase.",
            currencyDisplayName: "Green Light",
            currencyInternalName: "gl",
            currencyLayer: "g",
